...
public class TuesdayActivity extends DayActivity {
    public void insertData(String newEntry, String columnNumber) {
        boolean insertData = mDatabaseHelper.addData(newEntry, columnNumber, "tuesday_table");
        if (insertData) {
    ...
    protected void setListView() {
        Cursor cursor = mDatabaseHelper.getData("tuesday_table");
        int columnCount = 0;
        cursor.moveToFirst();
        ...
        fButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i;
                i = new Intent(TuesdayActivity.this, CreateTask.class);
        ...
        clearButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                new AlertDialog.Builder(TuesdayActivity.this)
                        ...
                        .setPositiveButton("Yes", new DialogInterface.OnClickListener()
                        {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                mDatabaseHelper.clearDatabase("tuesday_table");
                                finish();
                            }
                        })
                        .show();
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent editIntent = new Intent(TuesdayActivity.this, EditData.class);
...
//                mDatabaseHelper.deleteItem(listView.getId(), "tuesday_table");
