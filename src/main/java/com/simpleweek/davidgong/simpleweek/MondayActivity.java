...
public class MondayActivity extends DayActivity {
    ...
    protected void setListView() {
        ...
        fButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i;
                i = new Intent(MondayActivity.this, CreateTask.class);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent editIntent = new Intent(MondayActivity.this, EditData.class);
...
//                mDatabaseHelper.deleteItem(listView.getId(), "monday_table");
