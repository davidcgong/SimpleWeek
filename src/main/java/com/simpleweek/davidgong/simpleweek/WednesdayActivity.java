...
public class WednesdayActivity extends DayActivity {
    public void insertData(String newEntry, String columnNumber) {
        boolean insertData = mDatabaseHelper.addData(newEntry, columnNumber, "wednesday_table");
        if (insertData) {
    ...
    protected void setListView() {
        Cursor cursor = mDatabaseHelper.getData("wednesday_table");
        int columnCount = 0;
        cursor.moveToFirst();
        ...
        fButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i;
                i = new Intent(WednesdayActivity.this, CreateTask.class);
        ...
        clearButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                new AlertDialog.Builder(WednesdayActivity.this)
                        ...
                        .setPositiveButton("Yes", new DialogInterface.OnClickListener()
                        {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                mDatabaseHelper.clearDatabase("wednesday_table");
                                finish();
                            }
                        })
                        .show();
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent editIntent = new Intent(WednesdayActivity.this, EditData.class);
...
//                mDatabaseHelper.deleteItem(listView.getId(), "wednesday_table");
